...
Generated with [Bati](https://batijs.dev) ([version 290](https://www.npmjs.com/package/create-bati/v/0.0.290)) using this command:

```sh
pnpm create bati --react --tailwindcss --shadcn-ui --eslint
```
